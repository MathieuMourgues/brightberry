    ...
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <p>
            The Services are designed to foster creativity, collaboration, and constructive exchange between users. To protect the integrity of the platform and its community, all users must comply with these Terms, our Privacy Policy, and our Community Guidelines. These rules ensure that the platform remains safe, respectful, lawful, and welcoming for everyone.
          </p>

          <p>
            By accessing or using the Services, you acknowledge and agree to:
          </p>
          ...
          <p>
            If you disagree with any part of these Terms, you should not use the Services.
          </p>
          ...
          <p>
            You may access, save, and print the current version of these Terms at any time through our website or within the relevant application. We do not retain a copy of this contract on your behalf after its conclusion. The contractual language of these Terms is English.
          </p>

          <p>
            Your privacy and your ability to control your personal data are very important to us. Any information you provide is processed in accordance with our Privacy Policy, which governs the collection and use of your data.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">Section 2 - Registration and Contract</h2>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3 text-gray-900">Section 2.2 - Passwords and Account Access</h3>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3 text-gray-900">Section 2.3 - Eligibility</h3>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4 text-gray-900">Section 12 - Contact Information</h2>
          ...
          <div className="bg-gray-100 p-6 rounded-lg mt-6 mb-8">
            <p className="font-bold mb-2">Brightberry</p>
            <p>SIREN: 943 427 831 - Registered with the R.C.S. Toulon</p>
            <p>Registered office: 410 Avenue des Sènes, 83210 Solliès-Pont, France</p>
            <p>Email: contact@brightberry.fr</p>
            <p>Website: https://brightberry.fr</p>
          </div>
